...
// ============================================================================
     ...
     */
    void multi_read_cache_t(Definition* def, uint64_t* read_addresses, uint8_t address_count, size_t* byte_counts, void** return_buffers);
     ...
     */
    void multi_write_cache_t(Definition* def, void** write_buffers);
     ...
     */
    uint8_t multi_operation_compatible_t(Definition* def, uint64_t address_1, uint64_t address_2);
